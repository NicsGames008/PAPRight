...
insert into `Character`(UserID, NameCharacter, AvatarCharacter, Backgroud, Race, Health, Strength, Dexterity, Constitution, Intelligence, Mana) values(1, "character1", "object", "good", "that one", 1, 1, 1, 1, 1, 1);
